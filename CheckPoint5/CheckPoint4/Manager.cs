        ...
        public int manager_id
        {
            ...
            set
            {
                if (_manager_id != value)
                {
                    ...
                    {
                        throw new InvalidOperationException("The property 'manager_id' is part of the object's key and cannot be changed. Changes to key properties can only be made when the object is not being tracked or is in the Added state.");
                    }
                    _manager_id = value;
